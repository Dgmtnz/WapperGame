...
var ammo_box = preload("res://Player_Controller/Spawnable_Objects/Clips/blaster_i_clip.tscn")  # Asegúrate de reemplazar esto con la ruta a tu escena de caja de munición
